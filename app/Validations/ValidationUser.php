...
class ValidationUser
{
    ...
    public function validateUser($data, $model = null, $action = null, $photo = null, $id = null, $method)
    {
        if ($id !== null) {
            ...
            if ($user === null || !is_numeric($id)) {
                ...
                } else if ($cpf !== null && $cpf->cpf === Helpers::limpaCPF($data['cpf']) && $method !== 'PUT') {
                ...
                } else if ($email !== null && $email->email === $data['email'] && $method !== 'PUT') {
