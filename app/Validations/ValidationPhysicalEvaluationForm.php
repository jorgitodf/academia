...
class ValidationPhysicalEvaluationForm
{
    ...
    public function validatePhysicalEvaluationForm($data, $model = null, $registrationModel = null, $action = null)
    {
        ...
        if (!isset($data['user_id']) || empty($data['user_id'])) {
            ...
            if (!isset($data['pathologies']) || empty($data['pathologies'])) {
            ...
            if (!isset($data['injuries_surgeries']) || empty($data['injuries_surgeries'])) {
            ...
            if (!isset($data['controlled_medication']) || empty($data['controlled_medication'])) {
            ...
            if (!isset($data['alcoholic_beverage']) || empty($data['alcoholic_beverage'])) {
            ...
            if (!isset($data['chest']) || empty($data['chest'])) {
            ...
            if (!isset($data['waist']) || empty($data['waist'])) {
            ...
            if (!isset($data['left_arm']) || empty($data['left_arm'])) {
            ...
            if (!isset($data['right_arm']) || empty($data['right_arm'])) {
            ...
            if (!isset($data['left_leg']) || empty($data['left_leg'])) {
            ...
            if (!isset($data['right_leg']) || empty($data['right_leg'])) {
